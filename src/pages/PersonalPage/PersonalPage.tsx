  ...
  return (
    <div className="">
        <div className="flex fixed w-[100vw] h-[100vh]">
            <div className="w-[20%]  bg-gray-100 cursor-pointer ">
                <div onClick={gotohome} className="bg-[#3e4095] h-[40px] p-[5px] flex justify-center items-center" >
                    <img className='w-[100$] h-[100%]'  src={`https://res.cloudinary.com/drorqx56b/image/upload/v1720388603/Homstay%20Healing/logoPerson_rl7prt.png`} alt="LOGO"  />
                    <span className='m-[5px] text-white font-[900]'>HOMSTAY HEALING</span>
                </div> 
                <div className="w-[100%] min-h-[100%] p-[10px] cursor-pointer   ">
                    ...
                    <p>Tài khoản chính : <span className='font-[600]'>{formatCurrency(money) ? formatCurrency(money) : 0 } VND</span></p>
                    <div className="flex">
                    ...
                    <br />
                    <div className="w-[100%] min-h-[80px] bg-[#fff9e6] rounded-[10px] p-[5px] cursor-pointer">
                    ...
                    <div className="h-[40vh] overflow-y-auto pb-[100px]">
                        ...
                        <li className={`flex items-center justify-left pl-[20px] h-[40px] cursor-pointer hover:bg-white ${activeItemNav === 8 ? "font-[700] bg-gray-200" : ""} `}
                            onClick={() => {
                            dispatch({ type: actionTypes.LOGOUT})
                            navigate('/'); 
                            }} >
                            <span className='flex justify-around'> <IoIosLogOut  className='m-[3px]' /> <span>Đăng Xuất</span> </span>
                        </li>
                        </ul>
                    </div>
                </div>               
